...
<nav className="bg-white border-gray-200 dark:bg-gray-900">
  <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
    <a href="https://dim3.com/" className="flex items-center">
        <img src="https://www.dim3.com/Instances/Front/Corporate/Images/og-image.png" className="h-8 mr-3" alt="Dim3 Logo" />
        <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Dim3</span>
    </a>
